...
namespace OY {
    namespace PrimNaive {
        ...
        struct Solver {
            ...
            Solver(size_type vertex_cnt, const SumType &infinite = std::numeric_limits<SumType>::max() / 2) : m_vertex_cnt(vertex_cnt), m_infinite(infinite), m_total{}, m_cost(vertex_cnt) {
