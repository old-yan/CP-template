...
namespace OY {
    ...
    template <typename ValueType, typename ModifyType, bool InitClearLazy, Zkw::size_type MAX_NODE = 1 << 22, typename InitMapping = Zkw::NoInit, typename Operation, typename Mapping, typename Composition, typename TreeType = Zkw::Tree<Zkw::CustomLazyNode<ValueType, ModifyType, Operation, Mapping, Composition, InitClearLazy>, MAX_NODE>>
