...
namespace OY {
    namespace HBIT2DEX {
        using size_type = BIT2DEX::size_type;
        ...
        public:
            ...
            void add(size_type row1, size_type row2, size_type column1, size_type column2, const Tp &inc) { m_bit.add(row1, row2, column1, column2, {inc, Tp((-inc) * (m_ver_cnt - 1))}); }
