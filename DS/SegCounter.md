...
1. [P5494 【模板】线段树分裂](https://www.luogu.com.cn/problem/P5494)
2. [P8496 [NOI2022] 众数](https://www.luogu.com.cn/problem/P8496)
3. [P9233 [蓝桥杯 2023 省 A] 颜色平衡树](https://www.luogu.com.cn/problem/P9233)
...
void test() {
    using Counter = OY::SEGCOUNTER::Table<uint32_t, int, false, false, 1000>;
    Counter S1;
    S1.add(1, 200);
    S1.add(3, 100);
    S1.add(5, 50);
...
void test_range_query() {
    using Counter = OY::SEGCOUNTER::Table<uint64_t, int, true, true, 1000>;
    Counter S;
    S.add(1, 200);
    S.add(3999999, 100);
