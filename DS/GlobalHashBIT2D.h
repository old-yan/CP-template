...
namespace OY {
    namespace GBIT2D{
        ...
        template <typename KeyType, typename MappedType, bool RangeUpdate, bool MakeRecord, size_type BUFFER>
        class Tree {
        ...
        public:
            ...
            static void _special_add(Tree<KeyType, MappedType, RangeUpdate, MakeRecord, BUFFER> &x, KeyType r1, KeyType r2, KeyType c1, KeyType c2, MappedType inc) {
            ...
            Tree() = default;
            Tree(KeyType row, KeyType column) { resize(row, column); }
