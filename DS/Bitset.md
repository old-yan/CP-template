...
1. 数据类型
   ...
   模板参数 `uint32_t _Depth` ，表示一块的大小是 `1<<_Depth` 个 `unsigned long long` 。比如在默认参数 `_Depth = 6` 的情况下，一块的大小是 `64` 个 `unsigned long long ` ，即 `4096` 个比特。

   构造参数 `uint32_t __length` ，表示位集的大小为 `__length`。
...
1. 数据类型
   ...
   输入参数 `uint32_t __length` ，表示位集的大小为 `__length`。
...
1. 数据类型
   ...
   输入参数 `uint32_t __i` ，表示将下标 `__i` 位置置为 `1` 。
...
1. 数据类型
   ...
   输入参数 `uint32_t __left` ，表示要修改的区间的起始下标。

   输入参数 `uint32_t __right` ，表示要修改的区间的结尾下标。（闭区间）
...
1. 数据类型
   ...
   输入参数 `uint32_t __i` ，表示将下标 `__i` 位置置为 `0` 。
...
1. 数据类型
   ...
   输入参数 `uint32_t __i` ，表示将下标 `__i` 翻转。
...
1. 数据类型
   ...
   输入参数 `uint32_t __left` ，表示要查询的区间的起始下标。

   输入参数 `uint32_t __right` ，表示要查询的区间的结尾下标。（闭区间）
