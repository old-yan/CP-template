...
3. [P5057 [CQOI2006] 简单题](https://www.luogu.com.cn/problem/P5057)
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e6` 次操作，耗时约 `5.3s` 。
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e6` 次操作，耗时约 `3.4s` 。
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e6` 次操作，耗时约 `6.2s` 。
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e6` 次操作，耗时约 `6.6s` 。
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e6` 次操作，耗时约 `7.7s` 。
...
3. 备注
   ...
   对 `1e6` 大小的位集进行 `1e5` 次操作，耗时约 `1.7s` 。
